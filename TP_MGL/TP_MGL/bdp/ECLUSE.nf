...
THEORY ListInvariantX IS
  ...
  List_Invariant(Machine(ECLUSE))==(sas: NIVEAU & pav: PORTE & pam: PORTE & not(pam = ouverte & pav = ouverte) & not(pam = ouverte & sas = bas) & not(pav = ouverte & sas = haut))
END
&
...
THEORY ListPreconditionX IS
  List_Precondition(Machine(ECLUSE),remplir)==(sas = bas & (pam = fermee & pav = fermee));
  List_Precondition(Machine(ECLUSE),vider)==(sas = haut & (pam = fermee & pav = fermee));
  List_Precondition(Machine(ECLUSE),ouvrir_amont)==(sas = haut & (pam = fermee & pav = fermee));
  List_Precondition(Machine(ECLUSE),fermer_amont)==(sas = haut & (pam = ouverte & pav = fermee));
  List_Precondition(Machine(ECLUSE),ouvrir_aval)==(sas = bas & (pam = fermee & pav = fermee));
  List_Precondition(Machine(ECLUSE),fermer_aval)==(sas = bas & (pam = fermee & pav = ouverte))
END
&
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Machine(ECLUSE),fermer_aval)==(sas = bas & (pam = fermee & pav = ouverte) | pav:=fermee);
  Expanded_List_Substitution(Machine(ECLUSE),ouvrir_aval)==(sas = bas & (pam = fermee & pav = fermee) | pav:=ouverte);
  Expanded_List_Substitution(Machine(ECLUSE),fermer_amont)==(sas = haut & (pam = ouverte & pav = fermee) | pam:=fermee);
  Expanded_List_Substitution(Machine(ECLUSE),ouvrir_amont)==(sas = haut & (pam = fermee & pav = fermee) | pam:=ouverte);
  Expanded_List_Substitution(Machine(ECLUSE),vider)==(sas = haut & (pam = fermee & pav = fermee) | sas:=bas);
  Expanded_List_Substitution(Machine(ECLUSE),remplir)==(sas = bas & (pam = fermee & pav = fermee) | sas:=haut);
